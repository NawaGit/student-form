						...
						<div>
							<div>
								<h1 className="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">
									Data to enrich Vishwakarma University
								</h1>
								<p className="mt-6 text-lg leading-8 text-gray-600 sm:text-center">
									Data of every student in Vishwakarma University wich can be used to enrich the University and its students. For more information, please contact us.
