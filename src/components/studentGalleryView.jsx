...
const StudentGalleryView = ({ students, search }) => {
	return (
				...
				<div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
					...
					<div className="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
						{students.filter((val)=>{
							...
							<a key={students.id} href="#" className="group">
								...
								<h3 className="mt-4 text-3xl text-center text-gray-700">
									{student.firstName} {student.lastName}
								</h3>
								<p className="mt-1 text-lg text-center font-medium text-gray-900">
									{student.college} - <small>{student.department}</small>
								</p>
							</a>
						))}
					</div>
